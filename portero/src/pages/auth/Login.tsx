...
import { login, logout } from "../../services/redux/slices/AuthSlice.tsx";
        ...
        if (ValidateInfo()) {
            ...
            try {
                ...
                if (login.fulfilled.match(result)) {
                    ...
                    // Validar si el usuario es celador (role_id = 3)
                    if (user.role_id !== 3) {
                        // No es celador, cerrar sesión automáticamente
                        ...
                        showAlert(
                            'error',
                            'Acceso denegado. Solo los celadores pueden acceder a esta aplicación.',
                            { duration: 5 }
                        );
                    } else {
                        // Es celador, login exitoso
                        showAlert(
                            'success',
